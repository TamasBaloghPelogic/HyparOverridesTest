...
namespace OverrideTraining
{
    public class Function
    {
        ...
        private IModelStore<OverrideTrainingInputs> store;

        public async Task<OverrideTrainingOutputs> Handler(OverrideTrainingInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<OverrideTrainingInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
            }

            var l = new InvocationWrapper<OverrideTrainingInputs,OverrideTrainingOutputs>(store, OverrideTraining.Execute);
