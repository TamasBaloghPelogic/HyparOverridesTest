...
{
	/// <summary>
	/// Override metadata for ReprColorOverride
	/// </summary>
	public partial class ReprColorOverride : IOverride
	{
        public static string Name = "ReprColor";
	...
	public static class ReprColorOverrideExtensions
    {
		/// <summary>
        /// Apply ReprColor edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The ReprColor Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<ReprColorOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, ReprColorIdentity, bool> identityMatch,
            Func<T, ReprColorOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The ReprColor Overrides to apply — typically `input.Overrides.ReprColor`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<ReprColorOverride> overrideData,
            Func<T, ReprColorIdentity, bool> identityMatch,
            Func<T, ReprColorOverride, T> modifyElement
            ) where T : Element
        {
